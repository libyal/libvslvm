...
typedef struct vslvmtools_option vslvmtools_option_t;

struct vslvmtools_option
{
...
void vslvmtools_getopt_wrapped_fprint(
      FILE *stream,
...
void vslvmtools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const vslvmtools_option_t *options,
      int number_of_options );

int vslvmtools_getopt_get_options_string(
     const vslvmtools_option_t *options,
     int number_of_options,
