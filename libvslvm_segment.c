     ...
     libcerror_error_t **error )
{
		...
		error) != 1)
	{
		libcerror_error_set(
			...
			LIBCERROR_ERROR_DOMAIN_RUNTIME,
			LIBCERROR_RUNTIME_ERROR_INITIALIZE_FAILED,
			"%s: unable to create raids array.",
			function);
     ...
     libcerror_error_t **error )
{
	...
	if( *internal_segment != NULL )
	{
		...
		if (libcdata_array_free(
			&((*internal_segment)->raids_array),
			(int(*)(intptr_t **, libcerror_error_t **)) &libvslvm_internal_raid_free,
			error) != 1)
		{
			libcerror_error_set(
				error,
...
{
	libvslvm_internal_segment_t *internal_segment = NULL;
	static char *function = "libvslvm_segment_get_number_of_raids";
		...
		error) != 1)
	{
		libcerror_error_set(
			...
			LIBCERROR_ERROR_DOMAIN_RUNTIME,
			LIBCERROR_RUNTIME_ERROR_GET_FAILED,
			"%s: unable to retrieve number of elements from raids array.",
			function);
...
{
	libvslvm_internal_segment_t *internal_segment = NULL;
	static char *function = "libvslvm_segment_get_raid";
...
{
	libvslvm_internal_segment_t *internal_segment = NULL;
	static char *function = "libvslvm_segment_append_raid";
	int entry_index = 0;
...
int libvslvm_segment_get_type(libvslvm_segment_t * segment, uint32_t * type, libcerror_error_t ** error)
{
	libvslvm_internal_segment_t *internal_segment = NULL;
	static char *function = "libvslvm_segment_get_type";
	...
	if (type == NULL)
	{
		libcerror_error_set(
			...
			LIBCERROR_ERROR_DOMAIN_ARGUMENTS,
			LIBCERROR_ARGUMENT_ERROR_INVALID_VALUE,
			"%s: invalidt segment type.",
			function);

		return(-1);
	}
	*type = internal_segment->type;

	return(1);
}

int libvslvm_segment_get_stripe_size(libvslvm_segment_t * segment, uint32_t * stripe_size, libcerror_error_t ** error)
{
	libvslvm_internal_segment_t *internal_segment = NULL;
	static char *function = "libvslvm_segment_get_type";
	...
	if (stripe_size == NULL)
	{
		libcerror_error_set(
			...
			LIBCERROR_ERROR_DOMAIN_ARGUMENTS,
			LIBCERROR_ARGUMENT_ERROR_INVALID_VALUE,
			"%s: invalidt segment stripe_size.",
			function);

		return(-1);
	}
	*stripe_size = internal_segment->stripe_size;
