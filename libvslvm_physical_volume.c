     ...
     libcerror_error_t **error )
{
	...
	//+++add by liubo 2020017  resoved physical_volumes's  device = ""
	if (device_path_size <= 0)
	{
		//device_path_size = 1;
...
/* ++ 2018/12/28 add by liu bo
*/
/* Retrieves the pe_count
 * Returns 1 if successful or -1 on error
 */
int libvslvm_physical_volume_get_pe_count(
     libvslvm_physical_volume_t *physical_volume,
     size64_t *size,
     libcerror_error_t **error )
{
	libvslvm_internal_physical_volume_t *internal_physical_volume = NULL;
	static char *function                                         = "libvslvm_physical_volume_get_pe_count";
	...
	*size = internal_physical_volume->pe_count;

	return( 1 );
}

int libvslvm_physical_volume_get_pe_start(
     libvslvm_physical_volume_t *physical_volume,
     size64_t *size,
     libcerror_error_t **error )
{
	libvslvm_internal_physical_volume_t *internal_physical_volume = NULL;
	static char *function                                         = "libvslvm_physical_volume_get_pe_start";
	...
	*size = internal_physical_volume->pe_start;
